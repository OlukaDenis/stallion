...
export function DispatchedJobs({ t, quote, theme, isLoggedIn, userUID, isAdmin, isManager, isShippingAgent, isDriver }) {
...
DispatchedJobs.getInitialProps = async () => ({
  namespacesRequired: ['common', 'jobs_dispatched'],
});

DispatchedJobs.propTypes = {
...
export default connect(mapStateToProps, null)(withTranslation('jobs_dispatched')(DispatchedJobs));
