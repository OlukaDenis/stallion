                  ...
                  <Row gutter={[0, 0]} justify="center">
                    ...
                    <Col style={{ ...columnStyle }} xs={24} sm={24} md={10} lg={10} xl={8}>
                      <div className="date-item-block">
                        ...
                        <div className="date-item-child">
                          ...
                          >
                            <DatePicker
                              ...
                              disabledDate={(mMoment) => mMoment.isBefore(moment(new Date()).add(-60, 'days'))}
                              showToday={false}
                              onChange={(mMoment) => {
                        ...
                        <p>{Router.query['source'] === 'pickup'? ('Previous Delivery Date: '+order.delivered_date):('Previous Pickup Date: '+order.pickedup_date)}</p>
