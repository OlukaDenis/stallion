...
PendingJobs.getInitialProps = async () => ({
  namespacesRequired: ['common', 'jobs_pending'],
});
...
export default connect(mapStateToProps, null)(withTranslation('jobs_pending')(PendingJobs));
